...
func main() {
	...
	budget := flag.Float64("budget", 100.0, "Budget to buy Eth")
	...
	avgWindow := flag.Int("avg_window", 15, "number of buy intervals to consider for the DCA")
	flag.Parse()
